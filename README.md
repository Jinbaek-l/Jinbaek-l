...
- 🔬 의·생명 데이터 분석 및 통계 모델링 관련 국제저널 논문 2편 (공동1저자 1편, 공저자 1편) | **Domain**: Bioinformatics
- 🔍 공공데이터 활용 문제 해결 경진대회 2회 수상 | **Domain**: Mobility
- 🛠️ 현재, 도메인 확장 (게임·커머스) + 기술 역량 확장 (Python·SQL·딥러닝) 준비 중
